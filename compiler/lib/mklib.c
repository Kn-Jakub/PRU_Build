...
/*---------------------------------------------------------------------------
 * This is mklib version unknowable for PRU compiler  
...
library_t LIBRARIES[] = {
    ...
    { "rtspruv1_le_eh.lib", { "LITTLE_ENDIAN","V1","EXCEPTIONS","FULL_PORTABLE_EH" } },
    { "rtspruv2_le_eh.lib", { "EXCEPTIONS","V2","FULL_PORTABLE_EH","LITTLE_ENDIAN" } },
    ...
    { "rtspruv3_le_eh.lib", { "V3","LITTLE_ENDIAN","FULL_PORTABLE_EH","EXCEPTIONS" } },
    { "rtspruv1_be_eh.lib", { "V1","FULL_PORTABLE_EH","EXCEPTIONS","BIG_ENDIAN" } },
    { "rtspruv1_be.lib", { "V1","BIG_ENDIAN" } },
    { "rtspruv2_be_eh.lib", { "FULL_PORTABLE_EH","BIG_ENDIAN","V2","EXCEPTIONS" } },
    { "rtspruv3_le.lib", { "V3","LITTLE_ENDIAN" } },
    { "rtspruv3_be.lib", { "V3","BIG_ENDIAN" } },
};

const char *OBJ_SUBDIRS[] = { "libcxx","libcxx/ext","libcxx/include","libcxx/support/runtime","libcxx/support/ti","stlport","sys","xlocale" };
